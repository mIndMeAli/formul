...
form.addEventListener("submit", async function (event) {
    ...
    if (rawTanggal && isNaN(Date.parse(rawTanggal))) {
        showStatusMessage("Tanggal tidak valid!", "red");
        submitButton.disabled = false;
        return;
    }
    ...
    if (isFileUploaded) {
        try {
            ...
            fileDataPPPK = null;
            fileDataPNS = null;
            document.getElementById("uploadPPPK").value = "";
            document.getElementById("uploadPNS").value = "";
        } catch (error) {
